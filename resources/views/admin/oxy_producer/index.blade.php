        ...
        <div class="py-4 px-4">
            ...
            <div class="row mt-3">
                ...
                <div class="col-lg-10 mx-auto">
                    ...
                    <div id="read">
                        @include('admin.oxy_producer.read')
                    </div>
                </div>
    ...
    <script>
        $(document).ready(function () {
            ...
            function fetch_data(page,search=''){
                $.ajax({
                    url: '/admin/oxy_producer/read?page='+page+"&search="+search,
            ...
            $(document).on('click', '.remove',function(event) {
                ...
                swal({
                    ...
                    if (willDelete) {
                        ...
                        $.ajax({
                            type: "DELETE",
                            url: "/admin/oxy_producer/remove/" + id,
                            data: {
                            },
            ...
            $(document).on('click', '.edit',function(event) {
                event.preventDefault();
                var id = $(this).data('href');
                $.get("/admin/oxy_producer/edit/"+id,
                    function (data) {
            ...
            $("#actions").submit(function(event){
                ...
                $.ajax({
                    type: "POST",
                    url: "{{route('admin.oxy_producer.store')}}",
                    data: formData,
                    processData: false,
                    dataType: 'json',
                    contentType: false,
