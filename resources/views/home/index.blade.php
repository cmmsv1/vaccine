...
<div>
		...
		<div class="container-fluid">
			<div class="row">
				<div class="pogoSlider" id="js-main-slider">
					<div class="pogoSlider-slide" data-transition="fade" data-duration="1500" style="background-image:url({{asset('home/images/slider-01.jpg')}});">
					...
					<div class="pogoSlider-slide" data-transition="fade" data-duration="1500" style="background-image:url({{asset('home/images/slider-02.jpg')}});">
						<div class="lbox-caption pogoSlider-slide-element">
							<div class="lbox-details">
					...
					<div class="pogoSlider-slide" data-transition="fade" data-duration="1500" style="background-image:url({{asset('home/images/slider-03.jpg')}});">
						<div class="lbox-caption pogoSlider-slide-element">
							<div class="lbox-details">
								<h1>Welcome to Health Lab</h1>
								<p>Fusce convallis ante id purus sagittis malesuada. Sed erat ipsum </p>
						...
						<div class="row align-items-center about-main-info">
							...
							<div class="col-lg-6 col-md-6 col-sm-12">
								<div class="about-m">
									<ul id="banner">
										<li>
											<img src="{{asset('home/images/about-img-01.jpg')}}" alt="">
										</li>
										<li>
											<img src="{{asset('home/images/about-img-02.jpg')}}" alt="">
										</li>
										<li>
											<img src="{{asset('home/images/about-img-03.jpg')}}" alt="">
										</li>
									</ul>
								</div>
							</div>
			...
			<div class="popup-gallery row clearfix">
				<div class="col-md-3 col-sm-6">
					<div class="box-gallery">
						<img src="{{asset('home/images/gallery-01.jpg')}}" alt="">
						<div class="box-content">	
							<h3 class="title">Lorem ipsum dolor</h3>
							<ul class="icon">
								<li><a href="{{asset('home/images/gallery-01.jpg')}}"><i class="fa fa-picture-o" aria-hidden="true"></i></a></li>								
							</ul>
						</div>
					</div>
				</div>
				<div class="col-md-3 col-sm-6">
					<div class="box-gallery">
						<img src="{{asset('home/images/gallery-02.jpg')}}" alt="">
						<div class="box-content">
							<h3 class="title">Lorem ipsum dolor</h3>
							<ul class="icon">
								<li><a href="{{asset('home/images/gallery-02.jpg')}}"><i class="fa fa-picture-o" aria-hidden="true"></i></a></li>								
							</ul>
						</div>
					</div>
				</div>
				<div class="col-md-3 col-sm-6">					
					<div class="box-gallery">
						<img src="{{asset('home/images/gallery-03.jpg')}}" alt="">
						<div class="box-content">							
							<ul class="icon">
								<li><a href="{{asset('home/images/gallery-03.jpg')}}"><i class="fa fa-picture-o" aria-hidden="true"></i></a></li>								
							</ul>
						</div>
					</div>
				</div>
				<div class="col-md-3 col-sm-6">
					<div class="box-gallery">
						<img src="{{asset('home/images/gallery-04.jpg')}}" alt="">
						<div class="box-content">	
							<h3 class="title">Lorem ipsum dolor</h3>
							<ul class="icon">
								<li><a href="{{asset('home/images/gallery-04.jpg')}}"><i class="fa fa-picture-o" aria-hidden="true"></i></a></li>								
							</ul>
						</div>
					</div>
				</div>
				<div class="col-md-3 col-sm-6">
					<div class="box-gallery">
						<img src="{{asset('home/images/gallery-05.jpg')}}" alt="">
						<div class="box-content">							
							<h3 class="title">Lorem ipsum dolor</h3>
							<ul class="icon">
								<li><a href="{{asset('home/images/gallery-05.jpg')}}"><i class="fa fa-picture-o" aria-hidden="true"></i></a></li>								
							</ul>
						</div>
					</div>
				</div>
				<div class="col-md-3 col-sm-6">					
					<div class="box-gallery">
						<img src="{{asset('home/images/gallery-06.jpg')}}" alt="">
						<div class="box-content">
							<h3 class="title">Lorem ipsum dolor</h3>
							<ul class="icon">
								<li><a href="{{asset('home/images/gallery-06.jpg')}}"><i class="fa fa-picture-o" aria-hidden="true"></i></a></li>								
							</ul>
						</div>
					</div>
				</div>
				<div class="col-md-3 col-sm-6">
					<div class="box-gallery">
						<img src="{{asset('home/images/gallery-07.jpg')}}" alt="">
						<div class="box-content">
							<h3 class="title">Lorem ipsum dolor</h3>
							<ul class="icon">
								<li><a href="{{asset('home/images/gallery-07.jpg')}}"><i class="fa fa-picture-o" aria-hidden="true"></i></a></li>								
							</ul>
						</div>
					</div>
				</div>
				<div class="col-md-3 col-sm-6">
					<div class="box-gallery">
						<img src="{{asset('home/images/gallery-08.jpg')}}" alt="">
						<div class="box-content">		
							<h3 class="title">Lorem ipsum dolor</h3>
							<ul class="icon">
								<li><a href="{{asset('home/images/gallery-08.jpg')}}"><i class="fa fa-picture-o" aria-hidden="true"></i></a></li>								
							</ul>
						</div>
					</div>
				</div>
		...
		<div class="container">
			...
			<div class="row">
                <div class="col-md-4 col-sm-6">
                    <div class="our-team">
                        <div class="pic">
                            <img src="{{asset('home/images/img-1.jpg')}}" alt="">
                        </div>
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="our-team">
                        <div class="pic">
                            <img src="{{asset('home/images/img-2.jpg')}}" alt="">
                        </div>
                        <div class="team-content">
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="our-team">
                        <div class="pic">
                            <img src="{{asset('home/images/img-3.jpg')}}" alt="">
                        </div>
                        <div class="team-content">
		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-lg-4 col-md-6 col-sm-12">
					<div class="blog-inner">
						<div class="blog-img">
							<img class="img-fluid" src="{{asset('home/images/blog-img-03.jpg')}}" alt="" />
						</div>
						<div class="item-meta">
							<a href="#"><i class="fa fa-comments-o"></i> 5 Comment </a>
							<a href="#"><i class="fa fa-user-o"></i> Admin</a>
    ...
    <script src="{{asset('home/js/jquery.pogo-slider.min.js')}}"></script> 
	<script src="{{asset('home/js/slider-index.js')}}"></script>
